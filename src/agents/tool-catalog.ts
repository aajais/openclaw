...
const CORE_TOOL_DEFINITIONS: CoreToolDefinition[] = [
  ...
  {
    id: "query_wandb_tool",
    label: "query_wandb_tool",
    description: "Query W&B runs/metrics (W&B MCP)",
    sectionId: "web",
    profiles: ["full"],
    includeInOpenClawGroup: true,
  },
  {
    ...
    label: "query_weave_traces_tool",
    description: "Query Weave traces (W&B MCP)",
    sectionId: "web",
    profiles: ["full"],
    includeInOpenClawGroup: true,
  },
  {
    ...
    label: "count_weave_traces_tool",
    description: "Count Weave traces (W&B MCP)",
    sectionId: "web",
    profiles: ["full"],
    includeInOpenClawGroup: true,
  },
  {
    ...
    label: "create_wandb_report_tool",
    description: "Create W&B reports (W&B MCP)",
    sectionId: "web",
    profiles: ["full"],
    includeInOpenClawGroup: true,
  },
  {
    ...
    label: "query_wandb_entity_projects",
    description: "List W&B entity projects (W&B MCP)",
    sectionId: "web",
    profiles: ["full"],
    includeInOpenClawGroup: true,
  },
  {
    ...
    label: "query_wandb_support_bot",
    description: "Ask W&B SupportBot (W&B MCP)",
    sectionId: "web",
    profiles: ["full"],
    includeInOpenClawGroup: true,
  },
